...
//                 <td className=' flex justify-start px-4 items-center'><img src={product.img} alt={product.title} className='h-12 w-12 border-collapse border object-cover rounded-full shadow-md bg-purple-500' /></td>
