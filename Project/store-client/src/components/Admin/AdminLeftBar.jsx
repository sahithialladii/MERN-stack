...
const AdminLeftBar = () => {
  ...
  return (
    ...
    <div className='h-full w-full flex flex-col'>
      <div className='h-[10%] w-full text-purple-500 flex justify-center items-center font-bold text-2xl'>
        Max-Store
      </div>
      ...
      <div className='h-[10%] w-full flex items-end'>
          <div className=' px-8  w-full h-2/3 text-black flex justify-center text-lg font-bold items-center'>
            Logout
          </div>
        </div>
    </div>
